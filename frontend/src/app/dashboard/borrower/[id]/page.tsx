...
export default function BorrowerDetailPage() {
  ...
  if (loading && !originalFeatures) {
    return (
      <div className="flex flex-col items-center justify-center space-y-4 pt-32">
        <Activity className="w-8 h-8 text-amber-500 animate-spin" />
        <p className="text-gray-400 text-mono text-sm tracking-widest uppercase">Processing signals...</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-8 print:p-0 print:bg-black print:text-white print:min-h-screen">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="panel col-span-1 flex flex-col items-center justify-center p-8 text-center relative overflow-hidden print:border print:border-white/20">
          ...
          <div className="panel col-span-1 md:col-span-2 p-8 flex flex-col justify-center relative overflow-hidden print:border print:border-white/20">
